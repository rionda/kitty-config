...
alias w3m="w3m -graph -F -o confirm_qq=FALSE -o use_wide=TRUE -o color=TRUE -o auto_image=TRUE -o display_image=TRUE -o max_load_image=20 -o inline_img_protocol=4"
